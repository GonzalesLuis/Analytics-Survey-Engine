<x-layout title="Pre Session Survey">
    <h1 class="text-2xl font-bold tracking-tight text-slate-900">Pre Session Survey</h1>
    ...
    @if ($results)
        <div class="mt-8 border-t border-slate-200 pt-6">
            ...
            <div class="mt-3 space-y-1 text-sm text-slate-700">
                ...
                <p class="font-semibold text-slate-900">Pre-session SRLG Score: {{ round($results['average_score'], 2) }}</p>
            </div>
        </div>
    @endif
